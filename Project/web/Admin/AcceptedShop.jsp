...
<html lang="en" >
    ...
    <%  
        if (request.getParameter("rid") != null) {
                ...
                String upQry = "update tbl_shop set sh_sts='3' where sh_id='" + request.getParameter("rid") + "'";
    ...
    %>
    <body>
        <h1 align="center" id="heading">Shop Data</h1>
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                    int i = 0;
                    String selQry = "select * from tbl_shop c inner join tbl_place p on p.plc_id=c.plc_id inner join tbl_district d on d.dist_id=p.dist_id where sh_sts='1'";
                ...
                <tr>
                    <td><%=i%></td>
                    <td><%=rs.getString("sh_nme")%></td>
                    <td><%=rs.getString("dist_nme")%></td>
                    <td><%=rs.getString("plc_nme")%></td>
                    <td><%=rs.getString("sh_contct")%></td>
                    <td><%=rs.getString("sh_email")%></td>
                    <td align="center">
                        <a href="NewShop.jsp?rid=<%=rs.getString("sh_id")%>"><img src="../Assets/Template/Admin/img/menu-icon/remove.png"  width="25" height="25"></a>
                    </td>
                </tr>
                <%
                    }
