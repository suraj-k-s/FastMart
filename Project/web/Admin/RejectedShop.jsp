...
<html lang="en" >
    ...
    <%  
        if (request.getParameter("aid") != null) {
                ...
                String upQry = "update tbl_shop set sh_sts='2' where sh_id='" + request.getParameter("aid") + "'";
    ...
    <body>
        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                    int i = 0;
                    String selQry = "select * from tbl_shop c inner join tbl_place p on p.plc_id=c.plc_id inner join tbl_district d on d.dist_id=p.dist_id where sh_sts='2'";
                ...
                <tr>
                    ...
                    <td align="center">
                        <a href="NewShop.jsp?aid=<%=rs.getString("sh_id")%>"><img src="../Assets/Template/Admin/img/menu-icon/check.png" width="25" height="25"></a>&nbsp;&nbsp;&nbsp;&nbsp;
                       </td>
                </tr>
                <%
                    }
